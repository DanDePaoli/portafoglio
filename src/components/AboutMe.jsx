...
var AboutMe = (props) => (
  ...
  <div style={{ height: '50em', position: 'relative', marginBottom: '3em' }}>
    ...
    <div className="Banner-bar" id="onload-AboutMe">
      ...
      <div className="IconBar"><a href="https://www.linkedin.com/in/danieldepaoli/" target="_blank"><FaLinkedin className="Icons" /></a> | <a href="https://github.com/DanDePaoli" target="_blank"><FaGithub className="Icons" /></a> | <AiOutlineMail className="Icons" /></div>
    </div>
