      ...
      <div className="Projects-ProjectOuter">
        ...
        <div className="Projects-ProjectInner">
          <div className="Projects-ProjectInnerLeft">
            ...
            <div className="Resume-SkillChip"><Chip><DiJavascript1 /> Javascript</Chip>   <Chip><DiNodejsSmall /> Node.js</Chip> <Chip><DiReact /> React.js</Chip> <Chip><DiHtml5 /> HTML/CSS</Chip> <Chip><DiNodejsSmall /> Express</Chip> <Chip><DiMongodb /> MongoDB</Chip>  <Chip><FaAws /> AWS</Chip> <Chip><SiNginx /> NGINX</Chip></div>
...
<div id="CarouselOverflow">         <Carousel /></div>
      ...
      <div className="Projects-ProjectOuter">
        ...
        <div className="Projects-ProjectInner">
          <div className="Projects-ProjectInnerLeft">
            ...
            <div className="Resume-SkillChip"><Chip><DiJavascript1 /> Javascript</Chip>   <Chip><DiNodejsSmall /> Node.js</Chip> <Chip><DiReact /> React.js</Chip> <Chip><DiHtml5 /> HTML/CSS</Chip> <Chip><DiNodejsSmall /> Express</Chip> <Chip><DiMysql /> MySQL</Chip> <Chip><FaAws /> AWS</Chip> <Chip><GrDocker /> Docker</Chip></div>
